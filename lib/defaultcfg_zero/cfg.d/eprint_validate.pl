...
#	my( %args ) = @_;
#	my( $repository, $eprint, $for_archive, $problems ) = @args{qw( repository dataobj for_archive problems )};
#
#	push @$problems, $repository->make_text( 'Demo eprint validation trigger' );
#}, id => 'demo_id' );
