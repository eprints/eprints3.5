...
//DOMContentLoaded rather than window load because otherwise it's very easy to press a button before the event handler has been attached to it
document.addEventListener("DOMContentLoaded", function () {

    for (const facet of this.querySelectorAll("[data-ep-facet]")) {
        ...
        for (const value of values) {
            ...
            value.querySelector("input[type=checkbox]").addEventListener("change", updateFacet);
        }
