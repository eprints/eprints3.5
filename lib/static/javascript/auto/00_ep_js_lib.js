 ...
 * Helper Functions
 */
const outerHeight = (element) => element.offsetHeight + parseIntReturnNum( element.style.marginTop ) + parseIntReturnNum( element.style.marginBottom );
...
const parseIntReturnNum = (input) => parseInt(input) || 0;
