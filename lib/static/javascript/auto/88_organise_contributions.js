document.addEventListener("DOMContentLoaded", (event) => {
	...
	if( contrib_content !== null )
	{
		let toggle = document.createElement("div")
                let toggle_text = document.createTextNode("Advanced View")
                ...
                children.forEach((n) => {
                        ...
                        elems.forEach((elem) => {
                                if( elem.classList.contains("d-none") )
                                {
                                        ...
                                        if(typeof toggle_text_node !== 'undefined'){
                                                toggle_text_node.textContent="Simple View"
                                        }
                                ...
                                else
                                {
                                        ...
                                        if(typeof toggle_text_node !== 'undefined'){
                                                toggle_text_node.textContent="Advanced View"
                                        }
