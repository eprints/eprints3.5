...
<div id="lightbox" style="display: none;"><div id="outerImageContainer" style="width: 660px;"><div id="imageContainer"><img id="lightboxImage" alt="Lightbox"><div id="lightboxMovie" alt="Lightbox"></div><div id="loading"><img src="/style/images/lightbox/loading.gif" alt="Loading"></div></div></div><div id="imageDataContainer" style="width: 660px;"><div id="imageData"><div id="hoverNav"><div class="lightboxAction"><button id="prevLink" alt="Previous">← Previous</button></div><div class="lightboxAction"><button id="closeLink" alt="Close">Close ⨯</button></div><div class="lightboxAction"><button id="nextLink" alt="Next">Next →</button></div></div><div id="imageDetails"><span id="caption"></span><span id="numberDisplay"></span></div></div></div></div>`
		);
		...
		Lightbox.closeButton = fragment.getElementById('closeLink');
