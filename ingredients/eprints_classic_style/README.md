...
Contained within the ingredient will be many of the `.css` or `.js` files used for the classic EPrints styling which are no longer required now that core is using Bootstrap classes and component layouts. If your repository only uses parts of the old styling, it may be worth moving the specific files to archive level and removing this ingredient entirely.
