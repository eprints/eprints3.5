...
EPrints::Plugin::Screen::Staff::PersonSearch

=cut


package EPrints::Plugin::Screen::Staff::PersonSearch;
...
sub search_dataset
{
	...
	return $self->{session}->get_repository->get_dataset( "person" );
}
...
sub can_be_viewed
{
	...
	return $self->allow( "staff/person_search" );
}
...
sub from
{
	...
	my $sconf = $self->{session}->get_repository->get_conf( "search", "person" );
